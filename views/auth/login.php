...
<div class="auth-container">
    <div class="auth-box">
        ...
        <div class="auth-links">
            <a href="web.php?action=forgot-password">Quên mật khẩu?</a>
            <span class="divider">•</span>
            <a href="web.php?action=register">Đăng ký ngay</a>
        </div>

        <div class="social-divider"><span>Hoặc đăng nhập với</span></div>

        <div class="social-login">
            <a href="web.php?action=login-google" class="social-btn google">
