...
<head>
    ...
    <!-- Link các file CSS cần thiết -->
    <link rel="stylesheet" href="assets/css/base.css">      <!-- CSS cơ bản -->
    <link rel="stylesheet" href="assets/css/layout.css">      <!-- CSS layout (header, footer) -->
    <link rel="stylesheet" href="assets/css/components.css">  <!-- CSS components -->
    <link rel="stylesheet" href="assets/css/movie.css">      <!-- CSS cho trang phim -->
    <link rel="stylesheet" href="assets/css/booking.css">    <!-- CSS cho trang đặt vé -->
    <link rel="stylesheet" href="assets/css/checkout.css">   <!-- CSS cho trang thanh toán -->
    <link rel="stylesheet" href="assets/css/pages.css">     <!-- CSS cho các trang khác -->
</head>
<body>
<?php 
// Lấy action hiện tại từ URL để highlight menu tương ứng
        ...
        <div class="container">
            ...
            <div class="logo">
                <a href="<?= h(isAdmin() ? admin_url('admin_dashboard') : app_url('home')) ?>" class="logo-link">
                    ...
                    <!-- Text logo: hiển thị ADMIN hoặc bình thường -->
            ...
            <div class="header-toolbar">
                <?php if (isAdmin()): // Nếu là admin thì hiển thị menu admin ?>
                    <!-- Menu dành cho admin -->
                    ...
                    <!-- Phần bên phải: Tài khoản và Đăng xuất -->
                ...
                <?php else: // Nếu là khách hàng thì hiển thị menu customer ?>
                    ...
                    <div class="header-right">
                        ...
                        <div class="nav-group nav-actions">
                            <?php if (isCustomerLoggedIn()): // Kiểm tra đã đăng nhập chưa ?>
                                <!-- Đã đăng nhập: hiển thị Tài khoản và Đăng xuất -->
                                <a href="<?= h(account_profile_url()) ?>" class="nav-link nav-account <?= $currentAction === 'profile' ? 'active' : '' ?>">TÀI KHOẢN</a>
                                <a href="<?= h(account_logout_url()) ?>" class="nav-link">ĐĂNG XUẤT</a>
                            <?php else: // Chưa đăng nhập: hiển thị Đăng nhập và Đăng ký ?>
