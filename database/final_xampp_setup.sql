...
SELECT 'Lật Mặt 7: Một Điều Ước', 'Bộ phim tình cảm gia đình cảm động của đạo diễn Lý Hải.', 'Lý Hải', 'Đinh Y Nhung, Thành Hiền, Trương Minh Cường', 'Hành động, Tâm lý', 138, '2024-04-26', 'lat-mat-7.jpg', 'lat-mat-7.jpg', 'lat-mat-7.jpg', 'https://www.youtube.com/embed/d1ZHdosjNX8', '1'
FROM DUAL
