...
// Helper xử lý luồng OAuth với Google
// - Tạo URL đăng nhập, lấy access token và thông tin người dùng từ Google
class OAuthHelper {
    ...
    // Tạo URL chuyển hướng người dùng đến trang xác thực Google
    ...
    // Lấy access token từ Google bằng mã code trả về sau xác thực
